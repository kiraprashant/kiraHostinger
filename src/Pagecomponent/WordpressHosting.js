...
function WordpressHosting(props) {
    ...
    const {wordpresshostingData , addwordpresshosting} = props
  ...
  return (
    <>
         ...
         <Trust plan = "Workpress Hosting"/>
         <div className='container py-5'>
             <div className='row'>
                {wordpressHosting.map((elem)=>{
                  return(
                    ...
                    <div key = {elem.id} className = "col-lg-4 col-md-6 col-sm-12 my-3">
                       <div className='Webhostingborder text-center'>
                          ...
                          <button onClick={()=> addwordpresshosting(elem)} className='Add_To_Cart'> Add To Cart </button>
